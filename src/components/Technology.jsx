...
//             <h2 className='text-[#ffffff]'>space launch 101</h2>
//         </div>
//         <div className='flex justify-center gap-[110px]'>
//             <div className='flex gap-[50px] ml-[140px] mt-[100px] relative right-[120px]'>
//                 <div className="flex flex-col gap-[25px]">
//                   {technologies.map((tech, index) => (
//                         <button
//                             key={index}
//                             onClick={() => setActiveIndex(index)}
//                             className={`h-[55px] w-[55px] rounded-full font-bellefair text-[30px] flex items-center justify-center transition-all duration-300
//                             ${
//                                 activeIndex === index
...
//                     <h4 className='uppercase mt-[10px]  font-barlow text-[#D0D6F9] text-[10px] tracking-[2.5px]'>{activeTechnology.title}</h4>
//                     <h1 className='uppercase  font-bellefair  text-[#ffffff] text-[40px]'>{activeTechnology.name}</h1>
//                     <p className='text-[#D0D6F9] mt-[25px] font-barlow text-xs tracking-[2.5px] font-light'>
...
//                 alt={activeTechnology.image}
//                 className='h-[375px] w-[350px]'
//                 />
//             </div>
//         </div> 
//     </div>
...
//       {/* Title */}
//       <div className="flex font-barlow text-[18px] md:text-[22px] lg:text-[25px] tracking-[4px] gap-2 
//                       mt-6 lg:mt-[40px] uppercase justify-center md:justify-start md:ml-[35px] lg:pl-[150px]">
//         <h2 className="text-gray-700 font-extrabold">03</h2>
...
//         <div className="flex flex-col lg:flex-row gap-6 md:gap-[50px] lg:ml-[140px] lg:mt-[100px] lg:relative lg:right-[120px]">
          
//           {/* Circles */}
//           <div className="flex md:flex-row lg:flex-col justify-center md:justify-start gap-4 md:gap-6 lg:gap-[25px]">
//             {technologies.map((tech, index) => (
//               <button
//                 key={index}
//                 onClick={() => setActiveIndex(index)}
//                 className={`h-[40px] w-[40px] md:h-[50px] md:w-[50px] lg:h-[55px] lg:w-[55px] rounded-full font-bellefair text-[18px] md:text-[25px] lg:text-[30px] flex items-center justify-center transition-all duration-300
//                 ${
//                   activeIndex === index
//                     ? "bg-white text-black border border-white"
//                     : "bg-transparent text-white border border-gray-700 hover:border-white"
...
//           {/* Text */}
//           <div className="max-w-sm text-center md:text-center lg:text-left mt-6 md:mt-0">
//             <h4 className="uppercase font-barlow text-[#D0D6F9] text-[10px] md:text-[12px] tracking-[2.5px]">
//               {activeTechnology.title}
//             </h4>
//             <h1 className="uppercase font-bellefair text-white text-[28px] md:text-[35px] lg:text-[40px] mt-2">
//               {activeTechnology.name}
//             </h1>
//             <p className="text-[#D0D6F9] mt-4 font-barlow text-xs md:text-sm tracking-[2.5px] font-light">
//               {activeTechnology.description}
//             </p>
//           </div>
//         </div>

//         {/* Right: Image (first in phone/tablet) */}
//         <div className="flex justify-center md:justify-center lg:justify-end">
//           <img 
//             src={activeTechnology.image} 
//             alt={activeTechnology.image}
//             className="w-[250px] h-[220px] md:w-[400px] md:h-[300px] lg:w-[350px] lg:h-[375px] object-cover"
//           />
//         </div>
//       </div> 
//     </div>
...
//                 src={activeTechnology.image} 
//                 alt={activeTechnology.image}
//                 className="w-full h-[170px] object-cover object-bottom"
//             />
//         </div>
